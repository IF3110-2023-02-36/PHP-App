...
def products_faker(PRODUCTS_COUNT : int, CATEGORIES_LIMIT : int, PRICE_LOW : int, PRICE_HIGH : int, STOCK_LIMIT : int):
...
if __name__ == "__main__":
    ...
    PRICE_HIGH = 1000
    STOCK_LIMIT = 100
    products_faker(PRODUCTS_COUNT, CATEGORIES_LIMIT, PRICE_LOW, PRICE_HIGH, STOCK_LIMIT)
